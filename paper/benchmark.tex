...
Supplement~\ref{supp:benchmark} reports a survey of the other operator-learning
problems and a check of reflection symmetry. The survey uses a largely fixed
recipe with unequal splits and limited seed replication and is included for
context.
