...
identity remains valid without either claim. Figure~\ref{fig:spectra} applies
it to a separate $6000$-row subsample of the structural-mechanics training
design. At the diagnostic's fixed nugget $10^{-5}$, its effective dimension
is $103.12$. This is the trace of that subsample smoother, not a measurement
of the full $19000$-row deployed fit. The trace neither certifies generalization
nor reduces the cubic cost of a dense factorization.
