...
Proposition~\ref{prop:kf} identifies the second as held-out-within-batch
interpolation error. This motivates learning features for a later kernel
stage; it is not an unbiased population-risk estimate for the adaptively
trained network or its kernel head.
