...
For $\lambda=0$ and singular $K$, positive semidefiniteness of the augmented
Gram matrix implies $k(X,u)\in\operatorname{range}K$; hence $c=K^+k(X,u)$
satisfies $Kc=k(X,u)$ and the same argument applies.
\end{proof}
