...
equivariance condition of Proposition~\ref{prop:sym} is not assumed for this
refiner; these changes are empirical measurements.
...
The recorded fitting stages use validation-based choices. The release contains splits, code and per-seed
...
These cases are disjoint for this calibration exercise. The measured
coverages below are split diagnostics on the public test block. The marginal split-conformal theorem applies when the
