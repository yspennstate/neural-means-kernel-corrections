...
condition $\varrho<\min(t,1/t)$. Differentiating,
\[
...
\]
Both are positive on the interior region, since $t-\varrho>0$ and
$1-\varrho t>0$ there. Setting
...
training values $r_1(X)=g_u(X)$, the first display gives
