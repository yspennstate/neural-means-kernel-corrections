...
$R_j(w)=\mathbb E\,(w^\top\varphi_j(u)-G(u)_j)^2$, estimated on a validation
sample of size $m$ independent of the members.
\begin{enumerate}
...
\;\le\;\frac{8\,W b^2 D\,(1+WD)+2\,b^2(1+WD)^2\sqrt{\tfrac12\log(2q/\delta)}}
{\sqrt m}.
\]
...
\sqrt{\tfrac12\log\big(2q|\Gamma|/\delta\big)}\Big)}{\sqrt m}.
\]
...
of the squared floor, which is the margin by which the fitted convex stack sits
above $\bar e\sqrt{\bar\varrho}$ in Section~\ref{sec:experiments}. The bracket
