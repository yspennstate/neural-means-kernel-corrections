...
assumed as population bounds or, for $\kappa$, given in closed form. The estimator the pipeline fits differs from this one: it is selected by mean relative $L^2$ error
...
statement covers. Every statement in this section assumes candidates fixed independently of the validation sample, whereas in the deployed pipeline the same split selects checkpoints, members and, on OCO-2, coordinates; and the constants $B$, $b$, $L$, $W$ are population bounds,
