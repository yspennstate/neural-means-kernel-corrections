...
leaves validation error unchanged to two decimals. This is a result for the searched kernels and tuning budget. In the five-member campaign, nine seeds select the largest nugget
...
positive at all ten. These are finite-range fits.
...
quadratic risk $0.980\pm0.003$. That risk uses the stored deployed global weights. The six-member validation-matrix
