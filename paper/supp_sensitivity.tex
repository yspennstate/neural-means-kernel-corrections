...
predictor are held fixed. Thus the contrast includes propagation through the downstream fitting steps.
...
Radii are absolute Euclidean norms on the output grid. ``Constant'' uses scale one; ``disagreement'' uses the retained
ensemble spread. These are measurements on the public test block; the independence conditions are stated in Supplement~\ref{supp:conf}.}
